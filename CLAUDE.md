...
- In chat replies, write math as plain text: `2^n`, `P(q7 = 1)`, `<=`,
  `|psi>`, `sqrt(2)`.
- Do not use `$...$` or `$$...$$` in chat replies.
- This rule applies **only** to chat. The `.md` files in `docs/` render LaTeX
  correctly on GitHub and in the VS Code Markdown preview, so keep proper
  `$...$` and `$$...$$` math there.
